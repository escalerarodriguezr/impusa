    ...
    $.fn.uploadFile = function (options) {
	   ...
	   this.startUpload = function () {
        ...
        function createCustomInputFile (obj, group, s, uploadLabel) {
            ...
            var form = $("<div data-method='" + s.method + "' data-action='" + s.url + "' data-enctype='" + s.enctype + "'></div>");
            //var form = $("<form method='" + s.method + "' action='" + s.url + "' enctype='" + s.enctype + "'></form>"); //ISBUT. Eliminar etiqueta form porque entra en conflicto con jsvalidation al intentar validar dos forms
		...
		function defaultProgressBar(obj,s) {
            ...
            this.preview = $("<img class='ajax-file-upload-preview col-xs-12 col-sm-4' />").width(s.previewWidth).height(s.previewHeight).appendTo(this.statusbar).hide();
            this.filename = $("<div class='ajax-file-upload-filename col-xs-12 col-sm-8'></div>").appendTo(this.statusbar);
            this.progressDiv = $("<div class='ajax-file-upload-progress col-xs-12 col-sm-8'>").appendTo(this.statusbar).hide();
            ...
            this.del.addClass("ajax-file-upload-delete");
