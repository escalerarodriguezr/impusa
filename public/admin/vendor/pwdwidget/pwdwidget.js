...
function PasswordWidget(divid,pwdname)
{
	...
	this.showing_pwd=1;
	this.txtShow = '<i class="fa fa-eye"></i>';
	this.txtMask = '<i class="fa fa-eye-slash"></i>';
	this.txtGenerate = '<i class="fa fa-bolt"></i> Generar';
	this.txtWeak='Débil';
...
function _MakePWDWidget()
{
	...
	code += "<input type='password' class='pwdfield form-control' name='"+pwdname+"' id='"+this.pwdfieldid+"'>";

	this.pwdtxtfield=pwdname+"_text";

	this.pwdtxtfieldid = this.pwdtxtfield+"_id";

	code += "<input type='text' class='pwdfield form-control' name='"+this.pwdtxtfield+"' id='"+this.pwdtxtfieldid+"' style='display: none;'>";

	this.pwdshowdiv = pwdname+"_showdiv";

	this.pwdshow_anch = pwdname + "_show_anch";

	code += "<div class='pwdopsdiv' id='"+this.pwdshowdiv+"'><a href='#' class='pwdshowbutton' id='"+this.pwdshow_anch+"'>"+this.txtShow+"</a></div>";

	this.pwdgendiv = pwdname+"_gendiv";

	this.pwdgenerate_anch = pwdname + "_gen_anch";

	code += "<div class='pwdopsdiv' id='"+this.pwdgendiv+"'><a href='#' class='pwdgenbutton' id='"+this.pwdgenerate_anch+"'>"+this.txtGenerate+"</a></div>";

	this.pwdstrengthdiv = pwdname + "_strength_div";

	code += "<div class='pwdstrength' id='"+this.pwdstrengthdiv+"'><div class='bg_box'>";

	this.pwdstrengthbar = pwdname + "_strength_bar";

	code += "<div class='pwdstrengthbar' id='"+this.pwdstrengthbar+"'></div></div>";
...
function passwordStrength()
{
	...
	{
		strengthdiv.style.width=(score+1)*30+'px';
	}
